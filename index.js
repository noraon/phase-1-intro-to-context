...
const hoursWorkedDate= function(employee,soughtDate){
    let inEvent = timeInEvents.find(function(e){
...
const wagesEarnedOnDate = function(employee,dateSought) {
    let rawWage = hoursWorkedDate(employee,dateSought)
        *employee.payPerHour
...
const findEmloyeeByFirstName =function(srcArray, firstName) {
